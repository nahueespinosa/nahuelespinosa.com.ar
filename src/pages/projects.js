...
const ProjectsPage = (props) => (
    <Layout lang="en">
        ...
        <div id="main" className="alt style2">
            <section id="one">
                <div className="inner">
                    <p>In this page I've tried to include significant projects I've participated in. They are ordered from newest to oldest and I've included some tags to give an idea of the technologies involved.</p>
                </div>
            </section>
            <section id="two">
                <div className="inner">
                    <section>
                        <div className="content box">
                            ...
                            <p>
                                <span className="image left"><img src={project07} alt="" /></span>This webpage was developed with Gatsby framework (React, node.js) using <a href="https://github.com/codebushi/gatsby-starter-forty">this starter</a>. <br/>
                                I adapted the theme to my needs and added/modified various componentes (<Link to="/timeline#two">Timeline</Link>, Banner).
                            </p>
