                ...
                <div className="inner">
                    <section>
                        <div className="content box">
                            ...
                            <p>
                                <span className="image left"><img src={project07} alt="" /></span>Esta página fue desarrollada con Gatsby framework (React, node.js) usando <a href="https://github.com/codebushi/gatsby-starter-forty">este starter</a>. <br/>
                                Adapté el tema a mis necesidades y agregué/modifiqué varios componentes (<Link to="/es/timeline#two">Timeline</Link>, Banner).
                            </p>
